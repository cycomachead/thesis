...
* edX provides a custom problem type called `JSInput` {{ "edx-jsinput" | cite }} which gave us a clear path for integration with edX.
...
## {{ page.level }}.2 The Autograder Interface
