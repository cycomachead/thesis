...
module.exports = {
    ...
    filters: {
        cite: function (key) {
            var citation = _.find(bibData, {'citationKey': key.toUpperCase()}),
            ...
            if (citation != undefined) {
                ...
                return "[Citation <code>'" + key + "'</code> not found]";
            }
        }
    },
    ...
    hooks: {
        init: function () {
            ...
            bibData = bibtexParse.toJSON(bib);
            bibCount = 0;
        }
    },
...
function formatACM(item) {
    ...
    id = '"ref-item-' + item.number + '"';
    result = '<tr class="ref-row ref-row-' + 'acm' + '">' +
    '<td class="ref-link ref-link-' + 'acm' + 'id=' + id +'>' +
    + item.number + '.</td><td>\n';
